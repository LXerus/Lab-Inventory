...
public class UpdateRegistryController implements Initializable {
    @FXML
    private TextField configurar_registro_txtfl_id;
    @FXML
    private TextField configurar_registro_txtfl_registro;
    @FXML
    private TextArea configurar_registro_txtarea_descripcion;
    @FXML
    private Button configurar_registro_btn_eliminar;
    @FXML
    private Button configurar_registro_btn_guardar;
    @FXML
    private Button configurar_registro_btn_cancelar;
    private int id;
    private String name;
    ...
    public void deleteRegistry() {
        ...
        cancel();
        JOptionPane.showMessageDialog(null, "Register Eliminado.");
    }

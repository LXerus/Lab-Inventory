...
public class UpdateProductTypeController implements Initializable {
    ...
    @FXML
    private TextField modificar_tipo_txtfl_id;
    @FXML
    private TextField modificar_tipo_txtfl_tipoproducto;
    @FXML
    private TextArea midificar_tipo_txtarea_descripcion;
    @FXML
    private Button modificar_tipo_btn_cancelar;
    private int id;

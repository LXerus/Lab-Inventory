...
public class ProductCrud {
    ...
    public void create(Product product){
        ...
        try {
            preparedStatementProduct = connection.prepareStatement(sqlQuery);
            preparedStatementProduct.setString(1, product.getName());
            preparedStatementProduct.setString(2, product.getBrand());
            preparedStatementProduct.setString(3, product.getCas());
            preparedStatementProduct.setString(4, product.getInternalCode());
            preparedStatementProduct.setString(5, product.getStandardCode());
            preparedStatementProduct.setString(6, product.getLot());
            preparedStatementProduct.setDate(7, Date.valueOf(product.getEntryDate()));
            preparedStatementProduct.setDate(8, Date.valueOf(product.getExpiryDate()));
            preparedStatementProduct.setDate(9, Date.valueOf(product.getOpenDate()));
            preparedStatementProduct.setDate(10, Date.valueOf(product.getInvoiceDate()));
            preparedStatementProduct.setString(11, product.getInvoiceNumber());
            preparedStatementProduct.setDouble(12, product.getStock());
            preparedStatementProduct.setDouble(13, product.getCost());
            preparedStatementProduct.setBoolean(14, product.isControlledProduct());
            preparedStatementProduct.setInt(15, product.getGhs());
            preparedStatementProduct.setInt(16, product.getCellarID());
            preparedStatementProduct.setInt(17, product.getProviderID());
            preparedStatementProduct.setInt(18, product.getProductTypeID());
            preparedStatementProduct.setInt(19, product.getPresentationID());
            preparedStatementProduct.setInt(20, product.getRegistryID());
    ...
    public void updateStock(int idProducto, double consumo){
        ...
        try{
            preparedStatementProduct = connection.prepareStatement(sqlQuery);
            preparedStatementProduct.setDouble(1,consumo);
            preparedStatementProduct.executeUpdate();
...
//*****************************************************Listas para los ComboBox para los formularios de productos********************************************
    public ObservableList<Peresentation> getPresentationList(){
        ...
        try {
            ...
            while(resultSet.next()){
                ...
                presentationList.add(new Peresentation(id, presentation, measurementUnit));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }finally {
    ...
    public Peresentation getPresentation(int presentationID){
        Peresentation presentation = null;
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                presentation = new Peresentation(id, presentation_re, unit);
            }
        }catch (SQLException ex){
            ex.printStackTrace();
        }finally {
    ...
    private PreparedStatement preparedStatementProduct;

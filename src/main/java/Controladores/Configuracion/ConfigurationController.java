...
public class ConfigurationController implements Initializable {
    ...
    private boolean verifyData(){
        ...
        if(configuracion_txtfl_DB.getText().isEmpty()){valid = false;}

        if(configuracion_txtfl_ip.getText().isEmpty()){valid = false;}

        if(configuracion_txtfl_puerto.getText().isEmpty()){valid = false;}

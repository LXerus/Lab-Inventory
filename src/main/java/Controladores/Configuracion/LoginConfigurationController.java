...
public class LoginConfigurationController implements Initializable {
    ...
    private boolean verifyData(){
        ...
        if(login_config_txtfl_db.getText().isEmpty()){valid = false;}

        if(login_config_txtfl_servidor.getText().isEmpty()){valid = false;}

        if(login_config_txtfl_puerto.getText().isEmpty()){valid = false;}

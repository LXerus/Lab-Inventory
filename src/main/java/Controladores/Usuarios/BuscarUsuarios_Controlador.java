...
public class BuscarUsuarios_Controlador implements Initializable {
    ...
    public void buscarUsuario(){
        buscar_usuario_tabla_lista_usuarios.setItems(usuariosCrud.buscarUsuario(datosIntroducidos()));
    ...
    @FXML
    private TableView<Usuario> buscar_usuario_tabla_lista_usuarios;
    @FXML
    private TableColumn<Usuario, Integer> buscar_usuario_cl_id;
    @FXML
    private TableColumn<Usuario, String> buscar_usuario_cl_nombres;
    @FXML
    private TableColumn<Usuario, String> buscar_usuario_cl_apellidos;
    @FXML
    private TableColumn<Usuario, LocalDate> buscar_usuario_cl_fdi;
    @FXML
    private TableColumn<Usuario, String> buscar_usuario_cl_area;
    @FXML
    private TableColumn<Usuario, String> buscar_usuario_cl_activo;
    @FXML
    private TableColumn<Usuario, String> buscar_usuario_cl_email;
    @FXML
    private TableColumn<Usuario, String> buscar_usuario_cl_privilegios;
